...
export default function BrandTag({ className = "" }) {
  return (
    ...
    <span className={`brand-tag inline-flex items-center h-[23px] text-[13px] leading-none antialiased ${className}`}>
      l
      ...
      <span className="relative flex items-center justify-center w-[0.6em] h-full">
        ...
        <FireIcon className="absolute -top-[0.25em] -left-[0.03em] w-[8px] h-[8px] text-secondary pointer-events-none" />
      </span>
